...
void main() {
  final app = App(
    privateKey: _serverPrivateKey,
    publicKey: _serverPublicKey,
  );
  final jwt = JWT({}, subject: base64Encode(_clientPublicKey))
      .sign(app.privateKey, algorithm: JWTAlgorithm.EdDSA);
  ...
  test('sign/verify', () {
    print(jwt);
    JWT.verify(jwt, app.publicKey);
  });

  test('create admin JWT', () {
    print(app.adminJWT);
  });
}
